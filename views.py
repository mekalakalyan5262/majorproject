...
def UploadXrayAction(request):
    if request.method == 'POST':
        ...
        student_sql_query = "INSERT INTO patient_data(username,xray_file,detection_result,upload_date,permit_doctor) VALUES('" + uname + "','" + imagename + "','" + result + "','" + today + "','" + str(doctor) + "')"
